...
export const THEME_TOKENS: Record<EchoTheme, ThemeTokens> = {
  ...
  training: {
    ...
    card:        "#1A1008",
    card2:       "#22160A",
    border:      "rgba(220, 140, 90, 0.11)",
    text1:       "#F5EFEA",
    text2:       "#B89878",
    text3:       "#6E5038",
    accent:      "#BE5228",
    accentLight: "rgba(190,  82,  40, 0.15)",
    green:       "#84CC16",
    greenLight:  "rgba(132, 204,  22, 0.14)",
    amber:       "#E8A040",
    ...
    dusk:        "#C49278",
    duskLight:   "rgba(196, 146, 120, 0.14)",
    blue:        "#60A5FA",
    blueLight:   "rgba( 96, 165, 250, 0.12)",
    gold:        "#D48040",
    goldLight:   "rgba(212, 128,  64, 0.14)",
  },
...
export const TAB_BAR_UI: Record<EchoTheme, { accent: string; inactive: string; bg: string; overlay: string }> = {
  ...
  training: {
    accent:   "#BE5228",
    inactive: "#6E5038",
    bg:       "rgba(26, 16, 8, 0.92)",
    overlay:  "rgba(190, 82, 40, 0.08)",
  },
  measurement: {
    accent:   "#5AA86A",
    inactive: "#4E6850",
