...
import { addMealItemAction, quickAddMealItemAction, getRecentMealItemsAction, type RecentMealItem } from "../actions/meals";
import { addSavedMealToLogAction, getSavedMealsAction } from "../actions/saved-meals";
import { ensureAndToggleFavoriteAction, toggleFavoriteAction } from "../actions/foods";
...
import { BarcodeScanner, cameraErrorMessage, requestCameraStream } from "../components/barcode-scanner";
